# SUSE Support Bundle Analyzer Project Guide

This document contains the detailed project guide for SUSE Support Bundle Analyzer, including local setup, configuration, architecture, API behavior, analyzer coverage, KB indexing, security notes, and suggested future work.

For a quick product overview and demos, see the [root README](../README.md).
...
- [Longhorn Analysis](#longhorn-analysis)
- [Harvester Analysis](#harvester-analysis)
- [KB Index](#kb-index)
- [API](#api)
